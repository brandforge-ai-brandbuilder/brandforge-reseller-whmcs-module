...
WHMCS provisioning and addon module that connects WHMCS product lifecycle events to the [BrandForge](https://staging.brandforge.software) Godmode API — automating workspace provisioning, suspension, termination, package upgrades, SSO login, and client area dashboards for resellers and their customers.
...
2. **Activate the Addon module**
   ...
   - Godmode API URL: `https://staging.brandforge.software`
...
3. **Add a Server record**
   ...
   - Module: `BrandForge`
   - Hostname: `https://staging.brandforge.software`
...
|---|---|---|
| Godmode API URL | Base URL for the Godmode API (no trailing slash) | `https://staging.brandforge.software` |
